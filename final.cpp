...
/*void notification(sf::RenderWindow& window) {
  sf::RenderWindow window_notification(sf::VideoMode(200.f, 200.f), "Notification");
  window_notification.setPosition(sf::Vector2i(window.getSize().x - window_notification.getSize().x / 2,
                                               window.getSize().y - window_notification.getSize().y / 2));
  sf::RectangleShape caution;
  caution.setPosition(sf::Vector2f(window_notification.getPosition()));
  caution.setSize(sf::Vector2f(window_notification.getSize()));
  caution.setFillColor(sf::Color::White);
